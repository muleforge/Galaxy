 ...
 * 	'/Users/mark/Foo/src/org/mule/galaxy/ee/web/client/ui/RepositoryConstants.properties'.
 */
public interface RepositoryConstants extends com.google.gwt.i18n.client.Constants {

  /**
   * Translated "Specify the type of item you are adding, the workspace (parent) where you want it stored, and a name for it. Additional fields appear depending on the type of item you select. Click <b>Add</b> to create the item.".
   *
   * @return translated "Specify the type of item you are adding, the workspace (parent) where you want it stored, and a name for it. Additional fields appear depending on the type of item you select. Click <b>Add</b> to create the item."
   */
  @DefaultStringValue("Specify the type of item you are adding, the workspace (parent) where you want it stored, and a name for it. Additional fields appear depending on the type of item you select. Click <b>Add</b> to create the item.")
  ...
  /**
   * Translated "The repository stores artifacts. By default, your applications are in Default Workspace. You can browse the repository, view the details of your artifacts, and add metadata and comments about them.".
   *
   * @return translated "Translated "The repository stores artifacts. By default, your applications are in Default Workspace. You can browse the repository, view the details of your artifacts, and add metadata and comments about them.".
   */
  @DefaultStringValue("The repository stores artifacts. By default, your applications are in Default Workspace. You can browse the repository, view the details of your artifacts, and add metadata and comments about them.")
  @Key("repo_Tip")
  String repo_Tip();
}
