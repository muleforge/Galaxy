...
public interface AdministrationConstants extends com.google.gwt.i18n.client.Constants {
  ...
  /**
   * Translated "Modify the user's name and email address as needed. To enter a new password for this user, click  <b>Reset Password</b> and enter the password. To add a role, select it in the left list and click the right arrow (>); to remove a role, select it in the right list and click the left arrow button (<). Click <b>Save</b> to save the changes.".
   *
   * @return translated "Modify the user's name and email address as needed. To enter a new password for this user, click  <b>Reset Password</b> and enter the password. To add a role, select it in the left list and click the right arrow (>); to remove a role, select it in the right list and click the left arrow button (<). Click <b>Save</b> to save the changes."
   */
  ...
  @Key("admin_Edit_User_Tip")
  String admin_Edit_User_Tip();
