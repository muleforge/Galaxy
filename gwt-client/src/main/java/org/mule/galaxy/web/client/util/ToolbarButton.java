 ...
 * <dt><b>Events:</b></dt>
 * <p/>
 * <dd><b>BeforeSelect</b> : ToolbarButtonEvent(button, event)<br>
 ...
 * </dd>
 * <p/>
 * <dd><b>Select</b> : ToolbarButtonEvent(button, event)<br>
 ...
 * </dd>
 * <p/>
 * <dd><b>MenuShow</b> : ToolbarButtonEvent(button, item)<br>
 ...
 * </dd>
 * <p/>
 * <dd><b>MenuHide</b> : ToolbarButtonEvent(button, item)<br>
...
public class ToolbarButton extends BoxComponent implements IconSupport {
     ...
     * @param icon the icon
     */
    public ToolbarButton(String text, AbstractImagePrototype icon) {
        this(text);
        setIcon(icon);
    }
     ...
     */
    public ToolbarButton(String text, AbstractImagePrototype icon, SelectionListener<ToolbarButtonEvent> listener) {
        this(text, icon);
     ...
     * @param listener the selection listener
     */
    public ToolbarButton(String text, SelectionListener<ToolbarButtonEvent> listener) {
        this(text);
        addSelectionListener(listener);
    }
     ...
     */
    public void addSelectionListener(SelectionListener<ToolbarButtonEvent> listener) {
    ...
    public void onComponentEvent(ComponentEvent ce) {
        ...
        ToolbarButtonEvent be = (ToolbarButtonEvent) ce;
     ...
     */
    public void removeSelectionListener(SelectionListener<ToolbarButtonEvent> listener) {
    ...
    public void setIcon(AbstractImagePrototype icon) {
        if (rendered) {
            El oldIcon = buttonEl.selectNode(".toolbar-btn-image");
            if (oldIcon != null) {
                oldIcon.remove();
                el().removeStyleName("toolbar-btn-text-icon", "toolbar-btn-icon", "toolbar-btn-noicon");
            }
            el().addStyleName(
                    (icon != null ? (!Util.isEmptyString(text) ? " toolbar-btn-text-icon" : " toolbar-btn-icon") : " toolbar-btn-noicon"));
            Element e = null;
            String align = null;
            if (icon != null) {
                ...
                fly(e).addStyleName("toolbar-btn-image");
    ...
    protected ComponentEvent createComponentEvent(Event event) {
        return new ToolbarButtonEvent(this);
    }
    ...
    protected String getMenuClass() {
        if (menu != null) {
            if (arrowAlign == ButtonArrowAlign.BOTTOM) {
                return "toolbar-btn-arrow-bottom";
            } else {
                return "toolbar-btn-arrow";
            }
        } else {
            return "";
        }
    ...
    protected void onBlur(ToolbarButtonEvent e) {
    ...
    protected void onClick(ComponentEvent ce) {
        ...
        hideToolTip();
        if (!disabled) {
            ToolbarButtonEvent be = new ToolbarButtonEvent(this);
    ...
    protected void onKeyPress(ToolbarButtonEvent be) {
    ...
    protected void onRender(Element target, int index) {
        if (template == null) {
            if (buttonTemplate == null) {
                ...
                sb.append("<table cellspacing=\"0\" class=\"toolbar-btn\" role=\"presentation\"><tbody class=\"{2}\" >");
                sb.append("<tr><td class=\"toolbar-btn-tl\"><i>&#160;</i></td><td class=\"toolbar-btn-tc\"></td><td class=\"toolbar-btn-tr\"><i>&#160;</i></td></tr>");
                sb.append("<tr><td class=\"toolbar-btn-ml\"><i>&#160;</i></td><td class=\"toolbar-btn-mc\"><em class=\"{3}\" unselectable=\"on\"><button class=\"toolbar-btn-text\" type=\"{1}\" style='position: static'>{0}</button></em></td><td class=\"toolbar-btn-mr\"><i>&#160;</i></td></tr>");
                sb.append("<tr><td class=\"toolbar-btn-bl\"><i>&#160;</i></td><td class=\"toolbar-btn-bc\"></td><td class=\"toolbar-btn-br\"><i>&#160;</i></td></tr>");
        ...
        setElement(template.create((text != null && text.length() > 0) ? text : "&nbsp;", getType(), "toolbar-btn-"
                + scale.name().toLowerCase() + " toolbar-btn-icon-" + scale.name().toLowerCase() + "-"
