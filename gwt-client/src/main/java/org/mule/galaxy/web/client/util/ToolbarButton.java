 ...
 * <dt><b>Events:</b></dt>
 *
 * <dd><b>BeforeSelect</b> : ToolbarButton(button, event)<br>
 ...
 * </dd>
 *
 * <dd><b>Select</b> : ToolbarButton(button, event)<br>
 ...
 * </dd>
 *
 * <dd><b>MenuShow</b> : ToolbarButton(button, item)<br>
 ...
 * </dd>
 *
 * <dd><b>MenuHide</b> : ToolbarButton(button, item)<br>
...
public class ToolbarButton extends BoxComponent implements IconSupport {
  ...
  public void setIcon(AbstractImagePrototype icon) {
    if (rendered) {
      ...
      el().addStyleName(
          (icon != null ? ((text != null && text.length() > 0) ? " toolbar-btn-text-icon" : " toolbar-btn-icon") : " toolbar-btn-noicon"));
      if (icon != null) {
