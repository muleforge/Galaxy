...
public class WorkspacePanel extends AbstractCollectionPanel {
    ...
    public WorkspacePanel(Galaxy galaxy, RepositoryMenuPanel menuPanel,
    ...
    protected void showNewService() {
        LightBox popup = new LightBox(new AddNamedItemForm("Add New Service", "Service", repository.getRegistryService(), info));
        popup.show();
    }
