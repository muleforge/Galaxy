...
public class TypeForm extends AbstractAdministrationForm {
    ...
    public TypeForm(AdministrationPanel adminPanel, RepositoryModule repositoryModule) {
    ...
    protected void showPropertyForm(WPropertyDescriptor p) {
        ...
        innerForm.initialize(galaxy, repositoryModule.getPropertyInterfaceManager(), p, table);
    ...
    protected void fetchItem(String id) {
        registryService.getType(id, getFetchCallback());
    }
        ...
        final Listener<MessageBoxEvent> l = new Listener<MessageBoxEvent>() {
            public void handleEvent(MessageBoxEvent ce) {
                ...
                if (Dialog.YES.equals(btn.getItemId())) {
                    ...
                    registryService.deletePropertyDescriptor(type.getId(), getDeleteCallback());
                }
            }
        };

        MessageBox.confirm("Confirm", "Are you sure you want to delete type " + type.getName() + "?", l);
    }
