...
public class AddItemForm extends AbstractFlowComposite implements SubmitCompleteHandler {
    ...
    public AddItemForm(RepositoryMenuPanel menuPanel) {
        ...
        cp.setTopComponent(
                new InlineHelpPanel(repositoryModule.getRepositoryConstants().repo_Add_Item_Tip(), 21));
    ...
    private void setupAddForm() {
        ...
        parentSB = new SuggestBox(new ItemPathOracle(repositoryModule.getRegistryService(), errorPanel));
