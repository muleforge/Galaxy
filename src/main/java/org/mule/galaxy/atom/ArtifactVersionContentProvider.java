...
public class ArtifactVersionContentProvider extends AbstractCollectionProvider<ArtifactVersion> {
    ...
    public ArtifactVersion createMediaEntry(MimeType mimeType, String slug, InputStream inputStream) {
        try {
            return registry.newVersion(document, mimeType.toString(), slug, inputStream);
    ...
    public Content getContent(ArtifactVersion doc) {
        ...
        content.setMimeType(document.getContentType());
        return content;
    }
    ...
    public ArtifactVersion getEntry(String resourceName) {
        return document.getVersion(resourceName);
    }

    public ArtifactVersion getEntryFromId(String id) {
        return document.getVersion(id);
    }

    public String getId() {
        return ID_PREFIX + document.getId();
    }

    public String getId(ArtifactVersion entry) {
        return ID_PREFIX + document.getId() + ":" + entry.getVersion();
    }
    ...
    public String getTitle() {
        return document.getName() + " Revisions";
    }

    public String getTitle(ArtifactVersion entry) {
        return document.getName() + " Version " + entry.getVersion();
    }
